...
$REAL_HOME/jarvis $CLAUDE_HOME/jarvis none bind 0 0
...
echo "    3. Add this alias to ~/.zshrc:  alias jarvis='sudo -iu claude claude'"
echo "    4. Type 'jarvis' to start an isolated Claude session"
