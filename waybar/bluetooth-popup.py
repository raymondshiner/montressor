...
.popup-inner {
    ...
    box-shadow:
        ...
        0 0 20px rgba(0, 232, 198, 0.45),
        0 0 40px rgba(0, 232, 198, 0.20),
        0 0 0 1px rgba(0, 232, 198, 0.35);
}
.popup-inner.idle {
    box-shadow:
        0 0 28px rgba(0, 0, 0, 0.8),
        0 0 20px rgba(145, 221, 255, 0.45),
        0 0 40px rgba(145, 221, 255, 0.20),
        0 0 0 1px rgba(145, 221, 255, 0.35);
}
.popup-inner.off {
    box-shadow:
        0 0 28px rgba(0, 0, 0, 0.8),
        0 0 20px rgba(103, 118, 145, 0.45),
        0 0 40px rgba(103, 118, 145, 0.20),
        0 0 0 1px rgba(103, 118, 145, 0.35);
}
.header {
    color: #D5CED9;
